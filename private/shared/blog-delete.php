...
<body>
    ...
    <div class='title-header'>
        <div class="container">
            <h1 class="text-4xl font-light text-left text-spacing-tighter text-color-white">Delete Blog Details</h1>
        </div>
    </div>
...
<?php $blog_result = all_blogs(); ?>
        ...
        <form action="<?php echo url_for('blogs/delete.php'); ?>" method="POST" class="amend-form-pick" onsubmit="">
...
?>
        ...
        <div class="amend-form-outer">
            ...
            <form action="<?php echo url_for('blogs/delete.php'); ?>" method="POST" class="amend-form" onsubmit="">
                ...
                <textarea class="text-sm text-normal text-left text-spacing-tight text-color-black edit-title" id="blog-content" name="blog-content" rows="20"><?php echo $blog_picked['content']; ?></textarea>
