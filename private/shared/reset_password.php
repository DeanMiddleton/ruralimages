        ...
        if(isset($_POST['cust-email'])){
            ...
            <div class="amend-form-outer" style="max-width:320px; <?php echo $appear2; ?>">          
                <form action="<?php echo url_for('forgotten.php'); ?>" method="POST" class="amend-form" onsubmit="">
                    ...
                    <p class="text-base text-upper text-spacing-tight font-normal text-left">Enter your 5 number code here</p>
                    <input class="text-sm text-upper text-spacing-tight font-normal text-left" id="image-title" type="text" name="passcode" placeholder="*Passcode Eg.12345" required>
                    <p class="text-base text-upper text-spacing-tight font-normal text-left">Email</p>
                    <input class="text-sm text-upper text-spacing-tight font-normal text-left" id="image-title" type="text" name="cust-email" value="<?php echo $_POST['cust-email']; ?>">
                    <p class="text-base text-upper text-spacing-tight font-normal text-left">New Password</p>
                    <input class="text-sm text-upper text-spacing-tight font-normal text-left" id="image-title" type="text" name="new-password" placeholder="*Password" required>
                    <p class="text-base text-upper text-spacing-tight font-normal text-left">New Password Repeat</p>
                    <input class="text-sm text-upper text-spacing-tight font-normal text-left" id="image-title" type="text" name="new-password-r" placeholder="*Password" required>
                
                    <input class="btn" id="mybtn" type="submit" value="SUBMIT">

                </form> 
            </div>
                <p class="text-base text-center"><?php echo $reset_message; ?></p>
    </div>
</div>
