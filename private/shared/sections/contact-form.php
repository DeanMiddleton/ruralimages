...
<body>
    ...
    <p class="text-2xl font-normal text-left text-spacing-tighter text-color-black" style="padding: 10px 20px;">If you would like to discuss any of my images, products or a special request. You can contact me on a number of ways.</p><br>
