...
<body>
    ...
    <div class='title-header'>
        <div class="container">
            <h1 class="text-4xl font-light text-left text-spacing-tighter text-color-white">Delete Event Details</h1>
        </div>
    </div>
...
<?php $event_result = all_events(); ?>
        ...
        <form action="<?php echo url_for('events/delete.php'); ?>" method="POST" class="amend-form-pick" onsubmit="">
