...
<head>
    ...
    <meta name="description" content="<?php echo $pages[5]['meta_desc'] ?>">
    ...
    <title><?php echo $pages[5]['meta_title'] ?></title>
</head>
<body>
    ...
    <?php include(SHARED_PATH . '/sections/contact-form.php'); ?>
...
ID("contact").style.color = "var(--colorDecoBrown)";
