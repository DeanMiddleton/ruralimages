...
<meta charset="UTF-8">
    ...
    <meta name="description" content="<?php echo $pages[1]['meta_desc'] ?>">
    ...
    <title><?php echo $pages[1]['meta_title'] ?></title>
</head>
<body onload="fadeIn();">
<!-- Page Details -->
...
<?php include(SHARED_PATH . '/sections/header.php'); ?>
    ...
    <div id="loader">
        ...
        <?php include(SHARED_PATH . '/sections/gallery-feed.php'); ?>
...
ID("gallery").style.color = "var(--colorDecoBrown)";
